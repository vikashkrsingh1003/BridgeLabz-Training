...
public class NoteController {
	...
	public ResponseEntity<NoteResponse> addReminder(@PathVariable int id, @Valid @RequestBody ReminderRequest request) {

		NoteResponse response = noteService.addReminder(id, request);
