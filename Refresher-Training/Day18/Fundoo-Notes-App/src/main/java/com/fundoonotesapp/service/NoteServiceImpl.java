...
import com.fundoonotesapp.exception.InvalidNoteStateException;
import com.fundoonotesapp.exception.NoteNotFoundException;
import com.fundoonotesapp.exception.UserNotFoundException;
import com.fundoonotesapp.messaging.RabbitReminderProducer;
...
public class NoteServiceImpl implements NoteService {
	...
	public NoteServiceImpl(NoteRepository noteRepository, UserRepository userRepository, TagRepository tagRepository,
			RabbitReminderProducer rabbitReminderProducer) {
	...
	public NoteResponse createNote(NoteRequest request) {
		...
		log.info("Creating note for userId={}", getCurrentUser().getUserId());
		...
		log.info("Note created successfully. noteId={}, userId={}", savedNote.getNoteId(), currentUser.getUserId());
	...
	@Override
	public NoteResponse addReminder(int noteId, ReminderRequest request) {
		...
		// Save reminder time in the note
		...
		message.setMessage("Reminder for note: " + note.getTitle());
